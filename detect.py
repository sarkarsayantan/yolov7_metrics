...
def detect(save_img=False):
    source, weights, view_img, save_txt, imgsz, trace, save_stats_path = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, not opt.no_trace, opt.save_stats_path
